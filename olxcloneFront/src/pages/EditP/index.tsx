...
import { ImagesSelector } from "../../components/partials/ImagesSelector"
...
export const EditP = () => {
    ...
    const fileFields =[fileField0, fileField1, fileField2, fileField3, fileField4]
